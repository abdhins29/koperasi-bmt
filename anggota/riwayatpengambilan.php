...
?>
	<div class="box box-success">
		<div class="box-header with-border">
			<h3 class="box-title">Riwayat Pengambilan</h3>
		</div>
		<!-- /.box-header -->
		<div class="box-body">
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					$sql = mysqli_query($konek, "SELECT * FROM tbl_pengambilan a LEFT JOIN tbl_tabungan b ON a.id_anggota=b.id_anggota LEFT JOIN tbl_login c ON a.id_anggota=c.id_anggota WHERE c.id = '$_SESSION[id]'");
