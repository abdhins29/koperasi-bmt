	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class="form-group">
				<a href="tambahanggota.php"><i class="btn btn-primary btn-md"><span class="fa fa-plus fa-md"> Tambah Anggota</span></i></a>
			</div>
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td><a href="hapusanggota.php?kd=<?php echo $data['id_anggota']; ?>"><i class="btn btn-danger btn-sm"><span class="fa fa-trash fa-sm"></span></i></a></td>
						</tr>
					</tbody>
					<?php 
					}
